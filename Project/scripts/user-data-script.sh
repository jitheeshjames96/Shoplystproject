...
dnf install -y nginx && echo "Nginx installed"
systemctl start nginx && echo "Nginx started"
systemctl enable nginx && echo "Nginx enabled"

aws s3 cp s3://codebuildjitheesh/Project/scripts/index.html /usr/share/nginx/html/index.html && echo "Index.html file updated to nginx location"
